		...
		return this.props.agents.map(function (item) {
			return _react3.default.createElement(
				...
				_react3.default.createElement(
					"p",
					{ className: "col-md-6 col-lg-6 col-sm-6 col-xs-6 agentRows" },
					item.agentId
				),
				_react3.default.createElement(
					"p",
					{ className: "col-lg-6 col-md-6 col-sm-6 col-xs-6 time" },
					item.createdOn,
	...
	render: function render() {
		...
		return _react3.default.createElement(
			...
			_react3.default.createElement(
				...
				_react3.default.createElement(
					"div",
					{ className: "col-md-12 col-lg-12 col-sm-12 firstRow" },
			...
			_react3.default.createElement(
				...
				_react3.default.createElement(
					"p",
					{ className: "col-md-12 col-lg-12 col-sm-12 col-xs-12 buttonclass" },
					"Categories"
				),
				_react3.default.createElement(
					"p",
					{ className: "col-md-12 col-lg-12 col-sm-12 col-xs-12 buttonclass subcat", onClick: function onClick() {
			...
			_react3.default.createElement(
				"div",
				{ className: "col-md-5 col-lg-5 col-sm-5 col-xs-5 training border" },
				_react3.default.createElement(
					"div",
					{ className: "heading2" },
				...
				_react3.default.createElement(
					...
					_react3.default.createElement(
						"p",
						{ className: "col-lg-6 col-md-6 col-sm-6 col-xs-6 agentRowshead" },
						"Session"
					),
					_react3.default.createElement(
						"p",
						{ className: "col-lg-6 col-md-6 col-sm-6 col-xs-6 timehead" },
						"Created time"
					)
				),
				_react3.default.createElement(
			...
			_react3.default.createElement(
				"div",
				{ className: "col-md-7 col-lg-7 col-sm-7 col-xs-7 chatSession border" },
				_react3.default.createElement(
					"div",
					{ className: "heading3" },
					_react3.default.createElement(
...
//# sourceMappingURL=0.167940da851bfbf915e2.hot-update.js.map